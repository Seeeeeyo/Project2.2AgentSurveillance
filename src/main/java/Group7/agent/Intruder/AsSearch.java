...
//                   printMatrix(searchStates);
               ...
               if (target[0] == possibleNewX - xdiff && target[1] == possibleNewY - ydiff) { // checks if the agent is in the target area (in the simulation)
                    ...
                    */
                   System.out.println("Found the Target Area");
                   stop = true;
               }
               if (!stop) {
               ...
               while( x != (initialState[0]+xdiff) || y != (initialState[1]+ydiff)){
                 ...
                 //  System.out.println("action coord x = " + (moves[actions[x][y]-1][0]));
                  // System.out.println("action coord y = " + (moves[actions[x][y]-1][1]));
                   System.out.println("counterrr = " + counterrr);
